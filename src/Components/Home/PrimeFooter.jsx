...
const PrimeFooter = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-900">
      <footer
        ref={containerRef}
        className="relative min-h-screen bg-gray-900 overflow-hidden flex flex-col justify-center"
      >
        ...
        <div className="relative z-10 w-full px-4 md:px-8 lg:px-16">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mt-10 md:mt-15 lg:mt-2  mb-8">
              <h1
                ref={hashtagRef}
                className="text-4xl md:text-6xl lg:text-8xl font-black text-white tracking-tight"
              >
                #PRIME ENERGY DRINK
              </h1>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-16 items-center">
              <div className="space-y-8">
                <div className="space-y-4">
                  {[
                    ...
                    <div
                      key={i}
                      ref={addFooterLinkRef}
                      className="text-white hover:text-orange-400 cursor-pointer text-lg"
                    >
                      {text}
                    </div>
                  ))}
              ...
              <div className="flex justify-center relative">
                <div
                  ref={liquidRef}
                  className="absolute top-12 left-1/2 transform -translate-x-1/2 w-3 h-24 z-10"
                />
                ...
                <div className="absolute left-16 lg:-left-16 top-8 space-y-6">
                  {[
                    ...
                    {
                      Icon: InstagramIcon,
                      href: "https://www.instagram.com/iamnarenroy/",
                      color: "text-pink-600",
                    },
                    {
                      Icon: TwitterIcon,
                      href: "https://x.com/NarenRo26790356",
                      color: "text-black",
                    },
                    ...
                    <a
                      ...
                      className="w-12 h-12 bg-white rounded-full flex items-center justify-center cursor-pointer shadow-lg transition-transform duration-200"
                    >
                ...
                <div
                  ref={canRef}
                  className="relative w-[100vw] h-[80vh] lg:w-[50vw] lg:h-[50vh] mx-auto"
                >
                  <img
