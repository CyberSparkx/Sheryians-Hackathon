...
import { Zap, Droplets, Ban, Leaf } from "lucide-react";
import { Link } from "react-router-dom";

const PrimeEnergyCans = () => {
  ...
  const features = [
    {
      icon: <Zap className="text-5xl text-black" />,
      label: "200mg CAFFEINE",
    },
    {
      icon: <Droplets className="text-5xl text-black" />,
      label: "355mg ELECTROLYTES",
    },
    {
      icon: <Ban className="text-5xl text-black" />,
      label: "ZERO SUGAR",
    },
    {
      icon: <Leaf className="text-5xl text-black" />,
      label: "VEGAN",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
          ...
          <div className="flex justify-center">
            <img
              src="/Bottles-png/Primecans.png"
              alt="Prime Energy Cans"
          ...
          <div className="flex flex-col justify-center items-center lg:items-start py-8">
            <div className="grid grid-cols-2 gap-x-12 gap-y-16 w-full max-w-lg">
...
export default PrimeEnergyCans;