...
const Nav = () => {
  ...
  return (
    <nav
      ref={navRef}
      className="fixed top-0 left-0 w-full z-[100] p-6 flex items-center justify-between"
    >
      {/* Logo */}
      ...
      <Link
        to="/login"
        className="hidden md:block bg-white border px-6 py-2 rounded-full font-bold text-sm hover:bg-gray-100 transition"
      >
        SIGN UP
      </Link>
      ...
      >
        <div className="flex-1 p-8 flex flex-col justify-between">
          ...
          >
            ...
            <br />
            <Link to="/reviews" className="menu-item" onClick={handleLinkClick}>
              REVIEW PAGE
            </Link>
            <br />
            <Link to="/profile" className="menu-item" onClick={handleLinkClick}>
              PROFILE
            </Link>
            <br />
            ...
            <br />
            <Link to="/login" className="menu-item" onClick={handleLinkClick}>
              LOGIN
            </Link>
            <br />
          </div>
